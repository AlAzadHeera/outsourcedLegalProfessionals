...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('backend/img/fevicon.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('backend/img/fevicon.png') }}" type="image/x-icon">
...
<script src="{{ asset('backend/js/material-dashboard.js?v=2.1.1') }}../assets/" type="text/javascript"></script>
